...
import { View, StyleSheet, StatusBar, ScrollView, Text , FlatList , TouchableOpacity  , AsyncStorage, ActivityIndicator, Image  , Dimensions} from "react-native";
...
fetchMessages = async () => {
    ...
    const response = await fetch(
      CONSTANT.BaseUrl + "message_center/get_users?user_id="+Pid
    );
